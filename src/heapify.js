(() => {
  ...
  class MinHeap {
    ...
    print_heap() {
      console.log("FINAL MIN HEAP DATA ", this.data.slice(0), this.trial);
    }
  } // end of max_heap
  ...
  function tasks_min_heap() {
    ...
    console.log("min heap sorted values ", mxh.heap_sort());
  }
